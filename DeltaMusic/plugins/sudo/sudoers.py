...
from DeltaMusic.utils.database import add_sudo, remove_sudo
...
async def sudoers_list(client, message: Message, _):
    if message.from_user.id not in SUDOERS:
        return await message.reply_text("💔 <b>Pemilik:</b>\n1➤ <a href='https://t.me/KotakBiasa'>root@kotakbiasa.my.id:#</a>",
