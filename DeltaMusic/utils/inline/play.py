...
from DeltaStream.utils.formatters import time_to_seconds
from DeltaStream import app
...
def stream_markup(_, videoid, chat_id):
    buttons = [
        ...
        [
            ...
            InlineKeyboardButton(
                text="⛦ ᴄʜᴀᴛ ❥", url=f"https://t.me/DeltaStreamChat"
            ),
        ],
        [InlineKeyboardButton(text=_["CLOSE_BUTTON"], callback_data="close")],
    ]
...
def playlist_markup(_, videoid, user_id, ptype, channel, fplay):
    buttons = [
        [
            InlineKeyboardButton(
                text=_["P_B_1"],
                callback_data=f"deltaPlaylists {videoid}|{user_id}|{ptype}|a|{channel}|{fplay}",
            ),
            InlineKeyboardButton(
                text=_["P_B_2"],
                callback_data=f"deltaPlaylists {videoid}|{user_id}|{ptype}|v|{channel}|{fplay}",
            ),
        ],
        [
            InlineKeyboardButton(
...
def panel_markup_5(_, videoid, chat_id):
    buttons = [
        ...
        [
            InlineKeyboardButton(
                text="Resume", callback_data=f"ADMIN Resume|{chat_id}"
            ),
            InlineKeyboardButton(
