                ...
                if not admins:
                    ...
                    if message.from_user.id not in admins:
                        if await is_skipmode(message.chat.id):
                            ...
                            text = f"""<b>Hak admin diperlukan</b>

Segarkan cache admin melalui: /reload

» {upvote} suara diperlukan untuk melakukan tindakan ini."""
    ...
    async def wrapper(client, CallbackQuery):
        ...
        if not is_non_admin:
            try:
                ...
                if a is None:
                    return await CallbackQuery.answer("Error: Unable to retrieve chat member information.", show_alert=True)
                a = a.privileges
            except:
